...
export function Intro() {
  return (
    <div className="pb-1 flex flex-row content-between items-center">
      <div>
        <Gravatar />
        <div className="flex flex-col">
          <h3 className="text-2xl md:text-3xl">Oi, meu nome é</h3>
          <h1 className="font-bold text-3xl md:text-4xl">Caio Gouveia</h1>
        </div>
      </div>
      <div className="ml-auto flex items-center gap-4">
        <a
          href="https://github.com/caiogouveia"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/caiogouveia/"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 text-lg hover:opacity-70 transition-opacity"
        >
  ...
  return (
    <div className={"border-gradient-purple"}>
      <Image
        ...
        alt="Foto de perfil de Caio Gouveia"
        width={100}
        height={100}
