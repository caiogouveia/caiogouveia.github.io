...
export default function PrivacyPolicy() {
  return (
    <Container>
      ...
      <h2 className="text-xl font-bold mt-4">1. Coleta de informações</h2>
      <p>
        Coletamos informações pessoais apenas quando realmente precisamos
        delas para lhe fornecer um serviço. Fazemo-lo por meios justos e
        legais, com o seu conhecimento e consentimento. Também informamos por
        que estamos coletando e como será usado.
      </p>
      <h2 className="text-xl font-bold mt-4">2. Uso de dados</h2>
      <p>
      ...
      <h2 className="text-xl font-bold mt-4">3. Cookies</h2>
      <p>
        O nosso site pode usar cookies para melhorar a experiência do usuário.
        Cookies são pequenos arquivos de texto que são armazenados no seu
        dispositivo. Você pode desativar os cookies a qualquer momento nas
      ...
      <p>
        ...
        Aconselhamos que você revise esta página periodicamente para quaisquer
        alterações. Iremos notificá-lo sobre quaisquer alterações, publicando
        a nova Política de Privacidade nesta página.
      </p>
      <h2 className="text-xl font-bold mt-4">6. Contato</h2>
      <p>
